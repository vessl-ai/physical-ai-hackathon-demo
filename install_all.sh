...
echo "  - demo2-vla-inference-api: Test ACT inference"
echo "  - demo3-lerobot-visualization: Dataset visualization"
echo "  - demo4-simulation: gym-aloha simulation with ACT policy"
echo ""
